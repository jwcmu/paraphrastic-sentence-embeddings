...
def get_sequences(p1, p2, model, args, fr0=0, fr1=0):
    wp1 = Example(p1, args.lower_case)
    wp2 = Example(p2, args.lower_case)

    if fr0==1 and fr1==1 and not model.share_vocab:
        wp1.populate_embeddings(model.vocab_fr, model.zero_unk, args.ngrams)
        wp2.populate_embeddings(model.vocab_fr, model.zero_unk, args.ngrams)
...
def get_correlation(model, f, args, tok1, tok2, fr0=0, fr1=0):
    ...
    for n,i in enumerate(lines):
        ...
        wX1, wX2 = get_sequences(p1, p2, model, args, fr0, fr1)
